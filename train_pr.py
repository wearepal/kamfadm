...
def train(X, y, ns, opt):
    ...
    if opt.ltype == 4:
        ...
        clr = LRwPRType5(eta=opt.eta, C=opt.C)
        clr.fit(X, y, ns, itype=opt.itype)
    elif opt.ltype == 6:
        clr = LRwPRType6(eta=opt.eta, C=opt.C)
        clr.fit(X, y, ns, itype=opt.itype)
    elif opt.ltype == 7:
        clr = LRwPRType7(eta=opt.eta, C=opt.C)
        clr.fit(X, y, ns, itype=opt.itype)
    elif opt.ltype == 8:
        clr = LRwPRType8(eta=opt.eta, C=opt.C)
        clr.fit(X, y, ns, itype=opt.itype)
    elif opt.ltype == 9:
        clr = LRwPRType9(eta=opt.eta, C=opt.C)
        clr.fit(X, y, ns, itype=opt.itype)
    elif opt.ltype == 10:
        clr = LRwPRType10(eta=opt.eta, C=opt.C)
        clr.fit(X, y, ns, itype=opt.itype)
    elif opt.ltype == 11:
        clr = LRwPRType11(eta=opt.eta, C=opt.C)
        clr.fit(X, y, ns, itype=opt.itype)
    else:
